		...
		<div className="overflow-y-hidden">
			<div className="relative z-[-1] bg-black">
				<Image
					src={bg}
					alt="bg_land"
					className="object-cover w-screen h-screen opacity-10"
				/>
			</div>
			<div className="absolute top-0 left-0 flex flex-col items-center justify-center w-full h-full text-[rgb(220,220,220)]" id="fadeAndMove">
				<div className="border border-[rgb(40,40,40)] rounded-[100%] py-[60px] px-[50px] md:py-[120px] md:px-[100px] flex flex-col items-center justify-center">
